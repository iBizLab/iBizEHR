...
/**
 * 实体[HR_APPLICANT]处理逻辑[候选人基本信息导航栏计数]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class GetBaseinfoPageCount extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetBaseinfoPageCount.class)
