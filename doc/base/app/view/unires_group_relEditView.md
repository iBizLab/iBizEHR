# 权限组关联统一资源(unires_group_relEditView)  <!-- {docsify-ignore-all} -->
...
### 关联界面行为
  ...
  * [权限组关联统一资源(UNIRES_GROUP_REL)](module/base_extend/unires_group_rel) : [编辑界面_帮助操作](module/base_extend/unires_group_rel#界面行为)
