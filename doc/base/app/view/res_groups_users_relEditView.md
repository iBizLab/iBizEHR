# 权限组成员(res_groups_users_relEditView)  <!-- {docsify-ignore-all} -->
...
### 关联界面行为
  ...
  * [权限组成员(RES_GROUPS_USERS_REL)](module/base/res_groups_users_rel) : [编辑界面_帮助操作](module/base/res_groups_users_rel#界面行为)
