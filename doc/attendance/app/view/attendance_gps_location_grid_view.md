# GPS打卡(attendance_gps_location_grid_view)  <!-- {docsify-ignore-all} -->
...
### 关联视图
  * [GPS定位配置(attendance_gps_location_quick_create_view)](app/view/attendance_gps_location_quick_create_view)
